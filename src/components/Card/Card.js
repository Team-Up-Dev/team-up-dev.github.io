...
class CreateCards extends Component {
  ...
  createProgressBar = (repo) => {
    return (
      <ProgressBar variant={langAndTheColor(repo["lang"])}
        now={repo["value"]} data-lang={repo["lang"]} key={repo["lang"]} />
    )
  }
    ...
    return (
      <div className="cards-box">
        <div className="cards-box-container" id="cards-list">
          {!error && fetching ? content.map((card, index) => {
